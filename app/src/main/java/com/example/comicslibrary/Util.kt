...
//security algorith that it is required
...
//ayto einai state hoisting
@Composable
fun CharacterImage(url: String?, modifier: Modifier, contentScale: ContentScale = ContentScale.FillWidth) {
